                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body py-4">
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                            ...
                            <span class="badge bg-success fs-5 px-3 py-2" id="avanceRifaPct">0,00%</span>
                        </div>
                        <div class="progress rounded-pill" style="height: 28px;">
                            <div class="progress-bar bg-success fw-bold d-flex align-items-center justify-content-center"
                                 id="avanceRifaBar" role="progressbar" style="width: 0%; min-width: 0;"
                                 aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
                                <span id="avanceRifaBarText">0,00%</span>
                            </div>
                        </div>
