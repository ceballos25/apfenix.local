        ...
        <div class="body-wrapper-inner">
            <div class="container-fluid" style="padding: 0.5rem;">
                ...
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div>
                        <h5 class="fw-bold mb-0">Ventas Agente IA</h5>
                        <small class="text-muted">Pagos pendientes de validación desde Agente IA</small>
                    </div>
                </div>
...
<?php
$extra_js = '<script src="' . ASSETS_URL . '/js/ventas-chat.js"></script>';
